...
#
# The image preprocessing helpers below are adapted from the public
# `qwen_vl_utils.vision_process.py` implementation so this file can run as a
# standalone open-source script without additional private dependencies.
import base64
